...
cat > src/core/services/authService.js << 'SCRIPTEOF'
...
echo ""
echo "Listo. Panel de Inicio y aprovisionamiento de empresas creado."
echo "Siguiente paso:"
echo "  git add ."
echo "  git commit -m \"Agregar panel de inicio y flujo para crear empresas y usuarios\""
echo "  git push"
